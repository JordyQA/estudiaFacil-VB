Public Class preguntasSecundaria_Medio2

    Private Sub preguntasSecundaria_Medio2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Select Case grado2
            Case 1
                If contador = 6 Then
                    ...
                    Me.Hide()
                Else
                    preguntasSecundaria_Medio3.Show()
                    Visible = False
                    RadioButton1.Checked = False
                    RadioButton2.Checked = False
                    RadioButton3.Checked = False
