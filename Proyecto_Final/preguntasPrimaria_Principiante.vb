...
Public Class preguntasPrimaria_Principiante
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles btnSiguietne.Click
        ...
        Select Case grado
            Case 1
                ...
                Else
                    ...
                    preguntasPrimaria_Principiante2.Show()
                    Visible = False
    ...
    Private Sub btnValidar_Click(sender As Object, e As EventArgs) Handles btnValidar.Click
        ...
        Else
            ...
            MessageBox.Show("ERROR: tienes que seleccionar una opcion por cada pregunta", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            RadioButton1.Checked = False
            RadioButton2.Checked = False
            RadioButton3.Checked = False
            RadioButton4.Checked = False
    ...
    Private Sub preguntasPrimaria_Principiante_Load(sender As Object, e As EventArgs) Handles MyBase.Load
