Public Class preguntasPrimaria_Principiante3
    Private Sub preguntasPrimaria_Principiante3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Select Case grado
            Case 1
                If contador = 6 Then
                    ...
                    Me.Hide()
                Else
                    preguntasPrimaria_Principiante4.Show()
                    Visible = False
                    RadioButton1.Checked = False
                    RadioButton2.Checked = False
                    RadioButton3.Checked = False
