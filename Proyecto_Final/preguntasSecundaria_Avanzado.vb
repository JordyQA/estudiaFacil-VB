Public Class preguntasSecundaria_Avanzado

    Private Sub preguntasSecundaria_Avanzado_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Select Case grado2
            Case 1
                If contador = 6 Then
                    ...
                    Me.Hide()
                Else
                    preguntasSecundaria_Avanzado2.Show()
                    Visible = False
                    RadioButton1.Checked = False
                    RadioButton2.Checked = False
                    RadioButton3.Checked = False
