Public Class preguntasPrimaria_Principiante5
    Private Sub preguntasPrimaria_Principiante5_Load(sender As Object, e As EventArgs) Handles MyBase.Load
