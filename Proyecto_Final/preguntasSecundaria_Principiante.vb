Public Class preguntasSecundaria_Principiante
    Private Sub preguntasSecundaria_Principiante_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Select Case grado2
            Case 1
                If contador = 6 Then
                    ...
                    Me.Hide()
                Else
                    preguntasSecundaria_Principiante2.Show()
                    Visible = False
                    RadioButton1.Checked = False
                    RadioButton2.Checked = False
                    RadioButton3.Checked = False
